...
- Three-way stratified split (train/val/test) by patient
- Threshold selection: Youden’s J, fixed specificity, or max TPR under FPR constraint
- Comprehensive metrics: PR-AUC, prevalence-adjusted PR-AUC, partial ROC-AUC
...
class EyeMovementDetector:
    ...
    This detector classifies EEG segments as either clean or contaminated with muscle artifacts
    (e.g., EMG, jaw clenching). It uses a deep lightweight CNN architecture to promote generalization
    

    Attributes:
        model_name (str): Identifier for saving/loading the model.
    ...
    def evaluate(self) -> Dict[str, Any]:
        ...
        # ROC curve for Youden and other thresholds
        ...
        self._save_evaluation_plots(
            fpr, tpr, roc_auc_val,
            precision_val, recall_val, pr_auc,
    ...
    def plot_confusion_matrix(self, y_true: np.ndarray, y_pred: np.ndarray, threshold: float) -> None:
        ...
        plt.title(f'Confusion Matrix - Eye Movement Detector\nThreshold = {threshold:.3f}', 
