...
class EyeMovementDetector:
    ...
    def build_model(
        ...
        """
        Build a lightweight CNN for eye movement artifact detection.
    ...
    def _save_evaluation_plots(self, fpr, tpr, roc_auc, precision, recall, pr_auc, cm, threshold, y_proba_test, y_true_test):
        ...
        sns.heatmap(cm, annot=True, fmt='d', cmap='Blues', ax=axes[1, 0],
                    xticklabels=['Clean', 'Eye Movement'], yticklabels=['Clean', 'Eye Movement'])
        ...
        axes[1, 1].set_title('Prediction Distribution (Test)'); axes[1, 1].legend(); axes[1, 1].grid(True, alpha=0.3)
    ...
    def plot_training_history(self):
        ...
        for i, (metric, title, tc, vc) in enumerate(metrics):
            ...
            ax.set_xlabel('Epoch'); ax.set_ylabel(title); ax.legend(); ax.grid(True, alpha=0.3)
